...
app = FastAPI(
    ...
    description="Forecasting and scenario simulation service with Prophet/XGBoost/SHAP",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def health_check():
    return {"status": "healthy", "service": "forecasting-service", "timestamp": datetime.utcnow().isoformat()}
